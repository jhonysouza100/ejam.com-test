...
function page() {
  return (
    <>
      <Navbar />
      <main className="container sm:min-w-[380px] mx-auto px-4 lg:px-20 bg-body text-main">
      ...
      <section className="container py-4 text-main flex items-center justify-between">
        ...
        <section className="container px-4 grid grid-cols-4 gap-x-12">
          <span className="flex flex-col justify-center items-center space-y-1"><Avatar className="w-6 h-6 p-1 bg-lime-600"><RiCheckFill className="text-body" /></Avatar><p className="text-center text-nowrap text-[.65rem]">Cart Review</p></span>
          <span className="flex flex-col justify-center items-center space-y-1"><Avatar className="w-6 h-6 p-1 bg-lime-600"><RiCheckFill className="text-body" /></Avatar><p className="text-center text-nowrap text-[.65rem]">Checkout</p></span>
          <span className="flex flex-col justify-center items-center space-y-1"><Avatar className="w-6 h-6 p-1 bg-blue-600"><RiNumber3 className="text-body" /></Avatar><p className="text-center text-nowrap text-[.65rem] font-bold">Special Offer</p></span>
          <span className="flex flex-col justify-center items-center space-y-1"><Avatar className="w-6 h-6 p-1 border border-blue-600 bg-transparent"><RiNumber4 className=" text-blue-600" /></Avatar><p className="text-center text-nowrap text-[.65rem]">Confirmation</p></span>
        </section>
        ...
        <section className="pt-4 pb-8">
          ...
          <Image src={'/images/guarantee.png'} width={50} height={50} alt="macfee logo" />
